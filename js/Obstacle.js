// Obstacle class
export default class Obstacle {                                  // Exporta la clase para usarla en otros archivos
    constructor(gameScreen) {                                    // Se ejecuta al crear: new Obstacle()
    ...
    move() {                                                     // Actualiza posición cada frame (cae hacia abajo)
